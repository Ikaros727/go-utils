...
func Test_distributedLockRedis_TryLock(t *testing.T) {
	...
	lock := NewDistributedLockRedis(client, "unittest", 0)
	lock2 := NewDistributedLockRedis(client, "unittest", 0)
...
func Test_distributedLockRedis_TryLockWithTimeout(t *testing.T) {
	...
	lock := NewDistributedLockRedis(client, "unittest", time.Second*5)
	lock2 := NewDistributedLockRedis(client, "unittest", time.Second*5)
